---
title: "Lo que aprendí escribiendo, dictando y escuchando con IA — y lo que todavía no sé"
description: "Cierre de la serie: qué deberían hacer las interfaces de IA con todo lo que aprendimos sobre escribir, dictar y escuchar — y la pregunta incómoda que queda abierta."
...
Hay algo que vengo pensando desde que empecé a notar el patrón de la Parte 1, y quiero ser honesto con vos en lugar de simplificarlo: ¿esto que describí en toda la serie —usar la fricción del texto a tu favor, iterar con criterio, evaluar en vez de aceptar el primer output— es algo que cualquiera puede hacer con la misma facilidad?
