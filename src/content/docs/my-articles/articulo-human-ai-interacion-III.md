---
title: "Multitasking con IA: mismo curro de siempre, plot twist nuevo."
description: "La falacia de la multitarea aplicada a la inteligencia artificial: por qué escuchar en vez de leer te hace perder justo lo que fuiste a buscar."
...
## Cuándo el audio sí tiene sentido
...
Si querés el desarrollo completo de esta idea —incluida la comparación formal entre entrada de voz y salida de audio— sigue disponible sin editar en [mi repositorio de investigación](https://github.com/chamix/DOC/blob/main/src/human-ai-interaction/research/_investigacion-unificada.md).
